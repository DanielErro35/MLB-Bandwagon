...
```{r}
#write.csv(df_daily, file = "C:/Users/jille/OneDrive/Desktop/Thesis/MLB-Bandwagon/Daily_Data.csv", row.names = FALSE)
```
...
# Filter out all non playoff teams each year
# df_playoff <- df_playoff %>% 
#   filter(playoffs != "No Playoffs")
